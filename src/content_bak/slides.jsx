/**
 * Seus slides privados — este arquivo NÃO é versionado pelo Git.
 * Edite livremente!
 */
...
export default [
  ...
  <Slide key="publico">
    ...
    <div className="highlight-box">
      <p>
        ...
        Expansão possível sem custos adicionais para <strong>toda a América</strong>.
      </p>
    </div>
  </Slide>,

  /* ===== SLIDE 9 — Concorrência ===== */
  <Slide key="concorrencia">
    <h2>Concorrência</h2>
  ...
  <Slide key="modelo">
    ...
    <p>SaaS com cobrança por <strong>usuário ativo</strong> preços sugeridos:</p>
    <div className="pricing-cards">
      ...
      <div className="pricing-card featured">
        <h3>Plus</h3>
        <div className="price">R$ 15<span>/mês</span></div>
        <ul>
